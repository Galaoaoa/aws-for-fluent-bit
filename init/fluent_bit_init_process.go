...
func main() {
	...
	setECSTaskMetadata(metadata, invokerFile)
	...
	// will not write Fluent Bit command in the invoker.sh so Fluent Bit will not be invoked
	modifyInvokerFile(invokerFile)
}
