...
func TestSetECSTaskMetadata(t *testing.T) {
	...
	expectedContent1 := "export AWS_REGION=us-west-2\n" +
		"export ECS_CLUSTER=ygloa-Test\n" +
	...
	expectedContent2 := "export AWS_REGION=us-west-1\n" +
		"export ECS_CLUSTER=ygloa-Test\n"
...
func TestDownloadS3ConfigFile(t *testing.T) {
	...
	createS3ConfigFileDirectory(s3FileDirectoryPathTest)
